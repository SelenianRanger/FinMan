...
{
    public partial class EditExpenseTypeDialog : Form
    {
        public AdminModifyListener updateExpenseType { get; set; }

        private int id;

        public EditExpenseTypeDialog()
        {
            InitializeComponent();
        }
        ...
        private void done_btn_Click(object sender, EventArgs e)
        {
            ...
            if (!updateExpenseType(-1, type, 0, id))
            {
                this.stat_status.Text = "failed to update expense type";
                return;
            }
            else
            {
