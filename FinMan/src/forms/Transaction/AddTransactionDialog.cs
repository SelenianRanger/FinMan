...
namespace FinMan.forms.Transaction
{
    ...
    {
        public ModifyTransactionListener addTransaction { get; set; }
        ...
        private void done_btn_Click(object sender, EventArgs e)
        {
            ...
            if(!addTransaction(acc_id, type, type_id, amount, time, desc, 1, 0))
            {
                this.stat_status.Text = "failed to add transaction";
                return;
            } 
            else
            {
